...
def main():
    ...
    arcpy.Intersect_analysis([wholeClassProj, 'FirstYear\Polygons'], 'Points2.shp')
    arcpy.Intersect_analysis([wholeClassProj, 'LastYear\Polygons'], 'Points3.shp')

    # Convert Points2 and Points3 to raster, keeping their year values in conversion
    arcpy.PointToRaster_conversion('Points2.shp', 'YEAR', 'Band2.tif')
    arcpy.PointToRaster_conversion('Points3.shp', 'YEAR', 'Band3.tif')
